...
const Correcto = ({
  ...
  return (
    <Portal>
      <Dialog style={{ backgroundColor: theme.colors.white, width:screenWidth/1.2 }} visible={visible} onDismiss={() => goBack ? ( navigation.goBack(), setVisible(false)) : (navigation.navigate(RutaAnterior, { refresh: true }), setVisible(false))}>
        ...
        <Dialog.Actions style={{marginEnd:screenWidth/5.2, marginTop:10}}>
          ...
          backgroundColor={theme.colors.primary} color={theme.colors.white} 
            name={'cloud-check'}
            onPress={() => goBack ? navigation.goBack() : navigation.navigate(RutaAnterior, { refresh: true })} 
